        ...
        <div class="row">
                ...
                <div class="kobolg-banner style-01">
                    <div class="banner-inner">
                        <figure class="banner-thumb">
                            <?= Html::img('@web/themes/kobolg/assets/images/banner12.jpg', [
                                'alt' => 'img',
            ...
            <div class="col-sm-12 col-md-6 col-lg-6">
                <div class="kobolg-banner style-01">
                    <div class="banner-inner">
                        <figure class="banner-thumb">
                            <?= Html::img('@web/themes/kobolg/assets/images/banner13.jpg', [
                                'alt' => 'img',
                                'class' => 'attachment-full size-full'
                            ]) ?>
                        </figure>
                ...
                <div class="product-item featured_products style-02 rows-space-30 post-34 product type-product status-publish has-post-thumbnail product_cat-light product_cat-new-arrivals product_tag-light product_tag-hat product_tag-sock first instock sale featured shipping-taxable product-type-grouped">
                    <div class="product-inner tooltip-top">
                        <div class="product-thumb">
                            <a class="thumb-link"
                               href="#" tabindex="0">
                                <?= Html::img('@web/themes/kobolg/assets/images/apro61-1-270x350.jpg', [
                                    'alt' => 'Black Watches',
                    ...
                    <div class="product-inner tooltip-top">
                        <div class="product-thumb">
                            <a class="thumb-link"
                               href="#"
                               tabindex="0">
                                <?= Html::img('@web/themes/kobolg/assets/images/apro71-1-270x350.jpg', [
                                    'alt' => 'Gaming Mouse',
                                    'class' => 'img-responsive',
                                    'width' => '270',
                                    'height' => '350'
                    ...
                    <div class="product-inner tooltip-top">
                        <div class="product-thumb">
                            <a class="thumb-link"
                               href="#"
                               tabindex="0">
                                <?= Html::img('@web/themes/kobolg/assets/images/apro101-1-270x350.jpg', [
                                    'alt' => 'Mac 27 Inch',
                                    'class' => 'img-responsive',
                                    'width' => '270',
                                    'height' => '350'
                    ...
                    <div class="product-inner tooltip-top">
                        <div class="product-thumb">
                            <a class="thumb-link"
                               href="#"
                               tabindex="0">
                                <?= Html::img('@web/themes/kobolg/assets/images/apro91-1-270x350.jpg', [
                                    'alt' => 'Classic Watches',
                                    'class' => 'img-responsive',
                                    'width' => '270',
                                    'height' => '350'
                    ...
                    <div class="product-inner tooltip-top">
                        <div class="product-thumb">
                            <a class="thumb-link"
                               href="#"
                               tabindex="0">
                                <?= Html::img('@web/themes/kobolg/assets/images/apro1113-270x350.jpg', [
                                    'alt' => 'Red Consoles',
                                    'class' => 'img-responsive',
                                    'width' => '270',
                                    'height' => '350'
                    ...
                    <div class="product-inner tooltip-top">
                        <div class="product-thumb">
                            <a class="thumb-link"
                               href="#"
                               tabindex="0">
                                <?= Html::img('@web/themes/kobolg/assets/images/apro1211-2-270x350.jpg', [
                                    'alt' => 'Modern Watches',
                                    'class' => 'img-responsive',
                                    'width' => '270',
                                    'height' => '350'
                    ...
                    <div class="product-inner tooltip-top">
                        <div class="product-thumb">
                            <a class="thumb-link"
                               href="#"
                               tabindex="0">
                                <?= Html::img('@web/themes/kobolg/assets/images/apro141-1-270x350.jpg', [
                                    'alt' => 'Smart Monitor',
                                    'class' => 'img-responsive',
                                    'width' => '270',
                                    'height' => '350'
                    ...
                    <div class="product-inner tooltip-top">
                        <div class="product-thumb">
                            <a class="thumb-link"
                               href="#"
                               tabindex="0">
                                <?= Html::img('@web/themes/kobolg/assets/images/apro151-1-270x350.jpg', [
                ...
                <div class="product-item featured_products style-02 rows-space-30 post-24 product type-product status-publish has-post-thumbnail product_cat-chair product_cat-table product_cat-new-arrivals product_tag-light product_tag-hat product_tag-sock last instock featured shipping-taxable purchasable product-type-variable has-default-attributes">
                    <div class="product-inner tooltip-top">
                        <div class="product-thumb">
                            <a class="thumb-link"
                               href="#" tabindex="-1">
                                <?= Html::img('@web/themes/kobolg/assets/images/apro161-1-270x350.jpg', [
                                    'alt' => 'Gaming Mouse',
                                    'class' => 'img-responsive',
                                    'width' => '270',
                                    'height' => '350'
                    ...
                    <div class="product-inner tooltip-top">
                        <div class="product-thumb">
                            <a class="thumb-link"
                               href="#"
                               tabindex="-1">
                                <?= Html::img('@web/themes/kobolg/assets/images/apro181-2-270x350.jpg', [
                                    'alt' => 'Red Mouse',
                                    'class' => 'img-responsive',
                                    'width' => '270',
                                    'height' => '350'
...
<div>
    <div class="kobolg-banner style-02 left-center">
        <div class="banner-inner">
            <figure class="banner-thumb">
                <?= Html::img('@web/themes/kobolg/assets/images/banner101.jpg', [
                    'alt' => 'img',
                    'class' => 'attachment-full size-full',
                ]) ?>
            </figure>
                ...
                <div class="product-item recent-product style-01 rows-space-0 post-93 product type-product status-publish has-post-thumbnail product_cat-light product_cat-table product_cat-new-arrivals product_tag-table product_tag-sock first instock shipping-taxable purchasable product-type-simple  ">
                    <div class="product-inner tooltip-left">
                        <div class="product-thumb">
                            <a class="thumb-link"
                               href="#" tabindex="0">
                                <?= Html::img('@web/themes/kobolg/assets/images/apro13-1-270x350.jpg', [
                                    'alt' => 'Meta Watches',
                                    'class' => 'img-responsive',
                                    'width' => '270',
                                    'height' => '350'
                ...
                <div class="product-item recent-product style-01 rows-space-0 post-49 product type-product status-publish has-post-thumbnail product_cat-light product_cat-bed product_cat-sofas product_tag-multi product_tag-lamp  instock shipping-taxable purchasable product-type-simple">
                    <div class="product-inner tooltip-left">
                        <div class="product-thumb">
                            <a class="thumb-link"
                               href="#" tabindex="0">
                                <?= Html::img('@web/themes/kobolg/assets/images/apro302-270x350.jpg', [
                                    'alt' => 'Circle Watches',
                                    'class' => 'img-responsive',
                                    'width' => '270',
                                    'height' => '350'
                    ...
                    <div class="product-inner tooltip-left">
                        <div class="product-thumb">
                            <a class="thumb-link" href="#"
                               tabindex="0">
                                <?= Html::img('@web/themes/kobolg/assets/images/apro31-1-270x350.jpg', [
                                    'alt' => 'Blue Smartphone',
                                    'class' => 'img-responsive',
                                    'width' => '270',
                                    'height' => '350'
                ...
                <div class="product-item recent-product style-01 rows-space-0 post-35 product type-product status-publish has-post-thumbnail product_cat-chair product_cat-new-arrivals product_cat-lamp product_tag-light product_tag-hat product_tag-sock first instock shipping-taxable purchasable product-type-simple">
                    <div class="product-inner tooltip-left">
                        <div class="product-thumb">
                            <a class="thumb-link" href="#"
                               tabindex="0">
                                <?= Html::img('@web/themes/kobolg/assets/images/apro41-1-270x350.jpg', [
                                    'alt' => 'White Watches',
                                    'class' => 'img-responsive',
                                    'width' => '270',
                                    'height' => '350'
                ...
                <div class="product-item recent-product style-01 rows-space-0 post-36 product type-product status-publish has-post-thumbnail product_cat-table product_cat-bed product_tag-light product_tag-table product_tag-sock  instock sale shipping-taxable purchasable product-type-simple">
                    <div class="product-inner tooltip-left">
                        <div class="product-thumb">
                            <a class="thumb-link" href="#"
                               tabindex="-1">
                                <?= Html::img('@web/themes/kobolg/assets/images/apro51012-1-270x350.jpg', [
                                    'alt' => 'Multi Cellphone',
                                    'class' => 'img-responsive',
                                    'width' => '270',
                                    'height' => '350'
...
<div class="section-038">
    <div class="kobolg-banner style-07 left-center">
        <div class="banner-inner">
            <figure class="banner-thumb">
                <?= Html::img('@web/themes/kobolg/assets/images/banner28.jpg', [
                    'alt' => 'img',
                    'class' => 'attachment-full size-full',
                ]) ?>
            </figure>
            ...
            <div class="blog-list-owl owl-slick equal-container better-height"
                ...
                <article
                    ...
                    <div class="post-inner blog-grid">
                        <div class="post-thumb">
                            <a href="#" tabindex="0">
                                <?= Html::img('@web/themes/kobolg/assets/images/blogpost1-370x330.jpg', [
                                    'alt' => 'img',
                ...
                <article
                    ...
                    <div class="post-inner blog-grid">
                        <div class="post-thumb">
                            <a href="#"
                               tabindex="0">
                                <?= Html::img('@web/themes/kobolg/assets/images/blogpost5-370x330.jpg', [
                                    'alt' => 'img',
                                    'class' => 'img-responsive attachment-370x330 size-370x330',
                                    'width' => '370',
                                    'height' => '330'
                ...
                <article
                    ...
                    <div class="post-inner blog-grid">
                        <div class="post-thumb">
                            <a href="#"
                               tabindex="0">
                                <?= Html::img('@web/themes/kobolg/assets/images/blogpost9-370x330.jpg', [
                                    'alt' => 'img',
                                    'class' => 'img-responsive attachment-370x330 size-370x330',
                                    'width' => '370',
                                    'height' => '330'
                ...
                <article
                    ...
                    <div class="post-inner blog-grid">
                        <div class="post-thumb">
                            <a href="#"
                               tabindex="-1">
                                <?= Html::img('@web/themes/kobolg/assets/images/blogpost4-370x330.jpg', [
                                    'alt' => 'img',
                                    'class' => 'img-responsive attachment-370x330 size-370x330',
                                    'width' => '370',
                                    'height' => '330'
                ...
                <article
                    ...
                    <div class="post-inner blog-grid">
                        <div class="post-thumb">
                            <a href="#" tabindex="-1">
                                <?= Html::img('@web/themes/kobolg/assets/images/blogpost2-370x330.jpg', [
                                    'alt' => 'img',
                                    'class' => 'img-responsive attachment-370x330 size-370x330',
                                    'width' => '370',
                                    'height' => '330'
        ...
        <div class="instagram-owl owl-slick"
            ...
            <div class="rows-space-0">
                <a target="_blank" href="#" class="item"
                   tabindex="0">
                    <?= Html::img('@web/themes/kobolg/assets/images/insta1.jpg', [
                        'alt' => 'Home 01',
            ...
            <div class="rows-space-0">
                <a target="_blank" href="#" class="item" tabindex="0">
                    <?= Html::img('@web/themes/kobolg/assets/images/insta2.jpg', [
                        'alt' => 'Home 01',
                        'class' => 'img-responsive lazy',
                    ]) ?>
                    <span class="instagram-info">
            ...
            <div class="rows-space-0">
                <a target="_blank" href="#" class="item"
                   tabindex="0">
                    <?= Html::img('@web/themes/kobolg/assets/images/insta3.jpg', [
                        'alt' => 'Home 01',
                        'class' => 'img-responsive lazy',
                    ]) ?>
                    <span class="instagram-info">
            ...
            <div class="rows-space-0">
                <a target="_blank" href="#" class="item" tabindex="0">
                    <?= Html::img('@web/themes/kobolg/assets/images/insta4.jpg', [
                        'alt' => 'Home 01',
                        'class' => 'img-responsive lazy',
                    ]) ?>
                    <span class="instagram-info">
            ...
            <div class="rows-space-0">
                <a target="_blank" href="#" class="item" tabindex="0">
                    <?= Html::img('@web/themes/kobolg/assets/images/insta5.jpg', [
                        'alt' => 'Home 01',
                        'class' => 'img-responsive lazy',
                    ]) ?>
                    <span class="instagram-info">
            ...
            <div class="rows-space-0">
                <a target="_blank" href="#" class="item"
                   tabindex="-1">
                    <?= Html::img('@web/themes/kobolg/assets/images/insta6.jpg', [
                        'alt' => 'Home 01',
                        'class' => 'img-responsive lazy',
                    ]) ?>
                    <span class="instagram-info">
            ...
            <div class="rows-space-0">
                <a target="_blank" href="#" class="item"
                   tabindex="-1">
                    <?= Html::img('@web/themes/kobolg/assets/images/insta7.jpg', [
                        'alt' => 'Home 01',
                        'class' => 'img-responsive lazy',
                    ]) ?>
                    <span class="instagram-info">
            ...
            <div class="rows-space-0">
                <a target="_blank" href="#" class="item"
                   tabindex="-1">
                    <?= Html::img('@web/themes/kobolg/assets/images/insta8.jpg', [
                        'alt' => 'Home 01',
                        'class' => 'img-responsive lazy',
                    ]) ?>
                    <span class="instagram-info">
